...
var AMPLITUDE_DAMPEN_LOW_NOTES = .92;

var AMPLITUDE_DAMPEN_HIGH_NOTES = .87;
...
var Thread = function (f, c, b, a, d, e) {
...
Thread.prototype.updPos = function () {
    ...
    this.xMid = this.xp0 + this.dx * .5;
    this.yMid = this.yp0 + this.dy * .5;
...
Thread.prototype.updGrab = function () {
    ...
    if (this.rGrab <= .5) {
        this.rHalf = this.rGrab / .5;
    } else {
        this.rHalf = 1 - (this.rGrab - .5) / .5;
    }
...
Thread.prototype.pluck = function (g, c, m, l) {
    ...
    this.yc = this.yMid;
    if (this.isOsc) {
        this.rStrength = lim(this.rStrength * .5 + this.amp / this.ampMax, 0, 1);
