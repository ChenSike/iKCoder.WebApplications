...
Blockly.Blocks.procedures_callnoreturn = {
    ...
    setProcedureParameters_: function (a, b) {
        ...
        if (b) if (goog.array.equals(this.arguments_, a)) this.quarkIds_ = b;
            ...
            this.updateShape_();
            if (this.quarkIds_ = b) for (d = 0; d < this.arguments_.length; d++) e = this.quarkIds_[d], e in this.quarkConnections_ && (f = this.quarkConnections_[e], Blockly.Mutator.reconnect(f, this, "ARG" + d) || delete this.quarkConnections_[e]);
...
Blockly.Blocks.controls_flow_statements = {
    ...
    onchange: function (a) {
        if (this.workspace.isDragging && !this.workspace.isDragging()) {
            ...
            a ? (this.setWarningText(null), this.isInFlyout || this.setDisabled(!1)) : (this.setWarningText(Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING), this.isInFlyout || this.getInheritedDisabled() || this.setDisabled(!0))
        }
    },
