...
Blockly.BlockSvg.NOTCH_PATH_LEFT = 'l 7.5,4 7.5,-4';
/**
...
Blockly.BlockSvg.NOTCH_PATH_RIGHT = 'l -7.5,4 -7.5,-4';
/**
...
Blockly.BlockSvg.TAB_PATH_DOWN = 'v 8 l -' + Blockly.BlockSvg.TAB_WIDTH / 2 + ',0 0,' + Blockly.BlockSvg.TAB_WIDTH * 1.5 + ' ' + Blockly.BlockSvg.TAB_WIDTH / 2 + ',0 ';
/**
...
Blockly.BlockSvg.prototype.renderDrawTop_ =
    function (steps, highlightSteps, rightEdge) {
        ...
        // Top edge.
        if (this.previousConnection) {
            steps.push('H', Blockly.BlockSvg.NOTCH_WIDTH - 16);
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function (steps, highlightSteps) {
    if (this.outputConnection) {
        ...
        steps.push('l -' + Blockly.BlockSvg.TAB_WIDTH / 2 + ',0 0,-' + Blockly.BlockSvg.TAB_WIDTH * 1.5 + ' ' + Blockly.BlockSvg.TAB_WIDTH / 2 + ',0 ');
        if (this.RTL) {
