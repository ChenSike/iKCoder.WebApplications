 ...
 */
Blockly.Flyout.prototype.createDom = function (workspaceOptions) {
    /*
    <g>
    ...
    */
    ...
    this.svgBackground_ = Blockly.createSvgElement('path', params, this.svgGroup_);
    ...
    if (this.customCfg.border && this.customCfg.border.stroke && this.customCfg.border.width) {
        ...
        this.svgBackgroundBorder_ = Blockly.createSvgElement('path', params, this.svgGroup_);
    }
