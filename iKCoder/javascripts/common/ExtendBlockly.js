...
//Blockly.BlockSvg.CORNER_RADIUS = 1.417;
...
//Blockly.BlockSvg.INNER_TOP_LEFT_CORNER = Blockly.BlockSvg.NOTCH_PATH_RIGHT + ' h -' + (Blockly.BlockSvg.NOTCH_WIDTH - 17.677 - 1.417) + 'c-1.417 0.783,-0.635 0, -1.417 1.417';
//Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER = 'c0 0.783, 0.635 1.417, 1.417 1.417';
...
//            steps.push('h', Blockly.BlockSvg.NOTCH_WIDTH - 17.624 - 1.917);
//            //highlightSteps.push('H', Blockly.BlockSvg.NOTCH_WIDTH - 16.624);
//            steps.push(Blockly.BlockSvg.NOTCH_PATH_LEFT);
//            steps.push('h', 30);
...
//                //steps.push('v', Blockly.BlockSvg.SEP_SPACE_Y);
//                steps.push('a ' + (Blockly.BlockSvg.SEP_SPACE_Y / 2) + ',' + (Blockly.BlockSvg.SEP_SPACE_Y / 2) + ', 180, 1, 1, 0, ' + Blockly.BlockSvg.SEP_SPACE_Y);
//                if (this.RTL) {
//                    highlightSteps.push('v', Blockly.BlockSvg.SEP_SPACE_Y - 1);
//                }
//                cursorY += Blockly.BlockSvg.SEP_SPACE_Y;
